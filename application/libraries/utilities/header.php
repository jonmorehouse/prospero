...
*/
	...
	function Header(){
		...
		// LOADING LIBRARIES
		$libraries = array('utilities/browser_detection', 'property/property_get');
	...
	private function stylesheets($page_type, $passed_css){
	...
	private function javascript($page_type, $passed_javascript){
